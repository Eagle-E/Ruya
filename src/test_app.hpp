...
namespace ruya
{
	...
	public: // FUNCTIONS
		...
		void run()
		{
			...
			Shader shaderPhongObjects("shaders/phong/object.vert", "shaders/phong/object.frag");
			Shader shaderPhongLights("shaders/phong/object.vert", "shaders/phong/light_source.frag");
			Shader shaderFlat("shaders/flat/flat_vert.vert", "shaders/flat/flat_geom.geom", "shaders/flat/flat_frag.frag");
